            ...
            <div class="navbar-collapse  collapse">
              <ul class="nav navbar-nav navbar-right">
               <li class="active"><a href="index.php">Home</a></li>
                ...
                <li><a href="contact.html">Add an anouncement</a></li>
              </ul>
            </div>
            <!-- #Nav Ends -->
...
<div class="col-lg-3 col-sm-4 ">
  ...
  <form action="search.php" method="post" name="search">
    <input type="text" class="form-control" name="search" placeholder="Checher Propriétés">
    <div class="row">
            <div class="col-lg-5">
          ...
          <button name="submit" class="btn btn-primary">Trouvez</button>
</form>
  </div>
