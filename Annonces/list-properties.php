...
<div class="col-lg-3 col-sm-4 ">
  ...
  <div style="width:100%;height:0;padding-bottom:56%;position:relative;"><iframe src="https://giphy.com/embed/h43BdRKJc517rBWGHp" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div> 
...
<div class="pull-left result">Les propriétés disponnibles</div>
     ...
     <?php
      ...
      <div class="properties">
        <div class="image-holder"><img src="<?php echo $property_img; ?>" class="img-responsive" alt="properties">
          <?php if($availablility == 0){ ?><div class="status sold">Disponnible</div> <?php } else { ?>
          <div class="status new">Non disponnible</div>
          <?php } ?>
        </div>
        <h4><a href="property-detail.php?id=<?php echo $id; ?>"><?php echo $property_title;  ?></a></h4>
        <p class="price">Prix: $<?php echo $price; ?></p>
        <p class="price">Type: <?php echo $delivery_type; ?></p>
        <p class="price">Utilités: <?php echo $utility; ?></p>
