...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;background-color:#111">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">ANNONCES IMMOB</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
              ...
              <li><a href="<?php echo PREPEND_PATH; ?>membership_profile.php"><i class="fa fa-user"></i> <stron>Mon profil</strong> </a></li>
            ...
            <div class="navbar-inverse sidebar" role="navigation" >
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu" >
                        ...
                        <li>
                            <a href="houses_view.php"><i class="fa fa-building fa-fw"></i>Mes annonces</a>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Bienvenue <?php echo getLoggedMemberID(); ?> !</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
