<?php
	...
	$Translation['Reset Filters'] = 'Montrez tous';
	...
	$Translation['sign in']="Connectez vous";
	$Translation['signed as']="Vous êtes connecté en tant que";
	$Translation['sign out']="Déconnectez vous";
	...
	$Translation['sign in here']="Connectez Vous";
	$Translation['remember me']="Mémorisez mes données";
	$Translation['username']="Nom d'utilisateur";
	$Translation['password']="Mot de passe";
	$Translation['go to signup']="Pas de compte? <br />&nbsp; <a href=membership_signup.php>Créez un par là ! </a>";
	...
	$Translation['sign up here']="Inscrivez vous ! ";
