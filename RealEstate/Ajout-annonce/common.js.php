...
function houses_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field house_number can't be empty */
	if($j('#house_number').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Numero de propriété", close: function(){ /* */ $j('[name=house_number]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field features can't be empty */
	if($j('#features').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Caractéristiques", close: function(){ /* */ $j('[name=features]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field rent can't be empty */
	if($j('#rent').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Type d'acquisition", close: function(){ /* */ $j('[name=rent]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field status can't be empty */
	if($j('#status').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Disponnibilité", close: function(){ /* */ $j('[name=status]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function tenants_validateData(){
	$j('.has-error').removeClass('has-error');
	...
	if($j('#national_id').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> National ID", close: function(){ /* */ $j('[name=national_id]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	...
	/* Date field registration_date can't be empty */
	if($j('#registration_date-dd').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Registration date", close: function(){ /* */ $j('#registration_date-dd').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#registration_date-mm').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Registration date", close: function(){ /* */ $j('#registration_date-mm').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#registration_date').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Registration date", close: function(){ /* */ $j('#registration_date').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field house can't be empty */
	if($j('#house').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> House", close: function(){ /* */ $j('[name=house]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field status can't be empty */
...
function invoices_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field tenant can't be empty */
	if($j('#tenant').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Tenant", close: function(){ /* */ $j('[name=tenant]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	...
	/* Field month can't be empty */
	if($j('#month').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Month", close: function(){ /* */ $j('[name=month]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	...
	if($j('#total').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Total (Ksh)", close: function(){ /* */ $j('[name=total]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field status can't be empty */
...
function payments_validateData(){
	...
	if($j('#paid_amount').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Paid amount (Ksh)", close: function(){ /* */ $j('[name=paid_amount]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
...
function persist_expanded_child(id){
	var expand_these = Cookies.getJSON('RENTAL_MANAGEMENT.dvp_expand');
	...
	if($j('[id=' + id + ']').hasClass('active')){
		if(expand_these.indexOf(id) < 0){
			...
			Cookies.set('RENTAL_MANAGEMENT.dvp_expand', expand_these, { expires: 30 });
		}
	}else{
		if(expand_these.indexOf(id) >= 0){
