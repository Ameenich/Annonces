...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsFilters = array(   
		"`houses`.`id`" => "ID",
		"`houses`.`house_number`" => "Numéro de propriété",
		"`houses`.`features`" => "Features",
		"`houses`.`rent`" => "Rent",
		"`houses`.`status`" => "Status"
	);
	...
	$x->TableTitle = "Mes Annonces";
	$x->TableIcon = "resources/table_icons/building_add.png";
	$x->PrimaryKey = "`houses`.`id`";

	$x->ColWidth   = array(  150, 150, 150, 150);
	$x->ColCaption = array("Numéro de propriété", "Caractéristiques", "Type d'acquisition", "Disponibilité");
